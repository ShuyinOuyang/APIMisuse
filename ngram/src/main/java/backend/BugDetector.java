...
public class BugDetector {
    ...
    static HashSet<String> TB;
    static HashMap<String, Integer> detections;
    boolean isComputeBaseline = false;

    public BugDetector(String vocabPath, String tb) throws FileNotFoundException {
        System.out.println("[INFO] initializing client.");
        client = new Client(vocabPath);
    ...
    public static String test(double topN, double rrlimit,double problimit) throws FileNotFoundException {
        ...
        String vocabPath = "./newdata/jce/vocab.txt";
        String tb = "./data/test/tb";

        String pathsDir = "./data/test/testpath";

        BugDetector detector = new BugDetector(vocabPath, tb);
