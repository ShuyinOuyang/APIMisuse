package org.csu.src2aug.egroum;

import org.csu.src2aug.utils.JavaASTUtil;
import org.eclipse.jdt.core.dom.ASTNode;
import org.eclipse.jdt.core.dom.CompilationUnit;
import static org.csu.src2aug.egroum.EGroumDataEdge.Type.*;
...
public abstract class EGroumNode {
    ...
    private static HashSet<Integer> invocationTypes = new HashSet<>();
    private static HashSet<Integer> controlTypes = new HashSet<>();
    private static HashSet<Integer> literalTypes = new HashSet<>();
