...
public class PersistenceAUGDotExporter extends AUGDotExporter {
    ...
    public PersistenceAUGDotExporter() {
        super(PersistenceAUGDotExporter::getNodeType,
                PersistenceAUGDotExporter::getEdgeType,
                new NodeAttributeProvider(new AttributeProvider()),
                null);
    }
    ...
    public static class AttributeProvider implements NodeVisitor<Map<String, String>>{
        @Override
